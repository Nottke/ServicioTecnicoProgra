...
public class ServicioTecnico {
    public static void main(String[] args) {
        ...
        Servicio rutina;
        Servicio nuevoServicio1 = new Servicio("probando1",100);
        Servicio nuevoServicio2 = new Servicio("probando2",200);
        Servicio nuevoServicio3 = new Servicio("probando3",300);    
        OdT serviciosLimpieza = new OdT("Servicio de limpieza",10000);        
        serviciosLimpieza.agregarServicio(nuevoServicio1);
        serviciosLimpieza.agregarServicio(nuevoServicio2);
        serviciosLimpieza.agregarServicio(nuevoServicio3);
        OdT ordenTrabajo0 = new OdT(0,123456789,"ordenTesting0","04-04-2020",1000);// #orden,rut,servicio,fecha
        OdT ordenTrabajo1 = new OdT(1,234567890,"ordenTesting1","04-04-2020",2000);
        OdT ordenTrabajo2 = new OdT(2,154567891,"ordenTesting2","04-04-2020",3000);
        OdT ordenTrabajo3 = new OdT(3,184567892,"ordenTesting3","04-04-2020",4000);
        OdT ordenTrabajo4 = new OdT(4,141231234,"ordenTesting4","05-04-2020",5000);
        OdT ordenTrabajo5 = new OdT(5,132441234,"ordenTesting5","05-04-2020",6000);
        OdT ordenTrabajo6 = new OdT(6,167238234,"ordenTesting6","05-04-2020",7000);
        OdT ordenTrabajo7 = new OdT(7,203172385,"ordenTesting7","05-04-2020",8000);
